...
public class EggwarsAPI {
   ...
   public EggwarsAPI(Eggwars var1) {
      this.plugin = var1;
   }
   ...
   public boolean isSpectating(Player var1) {
      Arena var2 = ((PlayerData)this.plugin.playerData.get(var1.getName())).arena;
      return var2 != null && var2.spectators.contains(var1.getName());
   }

   public boolean isPlaying(Player var1) {
      Arena var2 = ((PlayerData)this.plugin.playerData.get(var1.getName())).arena;
      return var2 != null && var2.players.containsKey(var1.getName()) && !var2.spectators.contains(var1.getName()) && !var2.state.AVAILABLE();
   }

   public String getArenaName(Player var1) {
      return this.isInArena(var1) ? ((PlayerData)this.plugin.playerData.get(var1.getName())).arena.name : null;
   }

   public Team getTeam(Player var1) {
      return this.isPlaying(var1) ? (Team)((PlayerData)this.plugin.playerData.get(var1.getName())).arena.players.get(var1.getName()) : null;
   }

   public Set getTeams(String var1) {
      return ((Arena)this.plugin.arenas.get(var1.toLowerCase())).teams.keySet();
   }

   public Color translateChatColorToColor(ChatColor var1) {
      return this.plugin.filesManager.translateChatColorToColor(var1);
   }

   public ItemStack getItemStack(String var1, boolean var2, boolean var3) {
      return this.plugin.getItemStack(var1, var2, var3);
   }

   public String getItemStackString(ItemStack var1) {
      return this.plugin.getItemStackString(var1);
   }
