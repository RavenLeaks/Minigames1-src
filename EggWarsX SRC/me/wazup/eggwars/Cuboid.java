...
class Cuboid {
   ...
   public Location getRandomLocation() {
      ...
      int var3 = var2.nextInt((this.x2 - this.x1) / 2);
      int var4 = var2.nextInt((this.y2 - this.y1) / 2);
      int var5 = var2.nextInt((this.z2 - this.z1) / 2);
      Location var6 = new Location(var1, (double)(this.x1 + (this.x2 - this.x1) / 4 + var3), (double)(this.y1 + (this.y2 - this.y1) / 4 + var4), (double)(this.z1 + (this.z2 - this.z1) / 4 + var5));
