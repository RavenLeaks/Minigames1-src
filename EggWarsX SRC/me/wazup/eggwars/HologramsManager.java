...
class HologramsManager {
   ...
   public HologramsManager(Eggwars var1) {
      this.plugin = var1;
   }
   ...
   public void createStats(Player var1, PlayerData var2) {
      if (this.stats != null) {
         ...
         var2.hologram.appendTextLine(ChatColor.AQUA + "Eggs broken " + ChatColor.GRAY + Enums.SPECIAL_CHARACTER.ARROW + " " + ChatColor.YELLOW + var2.eggs_broken);
   ...
   public Hologram createGenerator(Location var1, ItemStack var2, int var3) {
      Hologram var4 = HologramsAPI.createHologram(this.plugin, var1);
      var4.appendItemLine(var2);
      var4.appendTextLine(ChatColor.AQUA + var2.getType().name());
      var4.appendTextLine(ChatColor.YELLOW + "Spawns in " + ChatColor.RED + var3 + ChatColor.YELLOW + " seconds");
      return var4;
   }

   public void updateGenerator(Hologram var1, int var2) {
      var1.removeLine(2);
      var1.insertTextLine(2, ChatColor.YELLOW + "Spawns in " + ChatColor.RED + var2 + ChatColor.YELLOW + " seconds");
   }
}
