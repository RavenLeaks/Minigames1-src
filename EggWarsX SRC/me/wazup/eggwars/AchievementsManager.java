...
class AchievementsManager {
   ...
   public AchievementsManager(Eggwars var1) {
      this.plugin = var1;
   ...
   public SmartInventory getAchievements(PlayerData var1) {
      SmartInventory var2 = new SmartInventory(this.plugin, (String)this.plugin.customization.inventories.get("Achievements-Inventory"));
      ...
      int[] var12 = new int[]{var1.kills, var1.wins, var1.projectiles_launched, var1.projectiles_hit, var1.player_rank, var1.blocks_placed, var1.blocks_broken, var1.eggs_broken};
   ...
   public class Achievement {
      ...
      public void send(Player var1) {
         ...
         AchievementsManager.this.plugin.fireWorkEffect(var1.getLocation(), true);
