package me.wazup.eggwars.events;
...
public class EWPlayerJoinArenaEvent extends Event {
   ...
   public EWPlayerJoinArenaEvent(Player var1, String var2, String var3, List var4) {
      this.p = var1;
      this.arenaName = var2;
