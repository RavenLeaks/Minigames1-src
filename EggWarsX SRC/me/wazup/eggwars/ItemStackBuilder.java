...
class ItemStackBuilder {
   ...
   public ItemStackBuilder setDurability(int var1) {
      if (Eggwars.setDamageMethod != null) {
         try {
            Eggwars.setDamageMethod.invoke(this.meta, (short)var1);
   ...
   public String getLastLore() {
      return (String)this.lore.get(this.lore.size() - 1);
   }
   ...
   public void setPotionEffect(String var1, int var2, int var3) {
      ((PotionMeta)this.meta).addCustomEffect(new PotionEffect(PotionEffectType.getByName(var1), var2 * 20, var3 - 1), true);
   }
