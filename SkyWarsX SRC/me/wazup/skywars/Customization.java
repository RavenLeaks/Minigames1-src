...
class Customization {
   ...
   public Customization(FileConfiguration var1) {
      ...
      var3 = var1.getConfigurationSection("TitleManager").getKeys(false).iterator();

      while(var3.hasNext()) {
         var2 = (String)var3.next();
         this.titles.put(var2, this.c(var1.getString("TitleManager." + var2)));
      }
      ...
      this.scoreboard_title = this.c(var1.getString("Scoreboard.Title"));
