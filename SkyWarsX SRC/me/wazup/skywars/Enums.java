...
public class Enums {
   protected static enum AchievementType {
      ...
      ITEMS_ENCHANTED("Enchant %x% item(s)!", 100, new int[]{1, 10, 50, 100}),
      ITEMS_CRAFTED("Craft %x% item(s)!", 10, new int[]{5, 20, 50, 100}),
      FISHES_CAUGHT("Catch %x% fish(es)!", 250, new int[]{1, 5, 10, 20});
